...
- **3 comptes bancaires opérationnels potentiels** (Mizrahi IL, banque IL perso, DFENSER FR) — banque DFENSER non renseignée
...
| 3 | **DFENSER (banque FR)** | Banque pro EI | FR | EUR | Banque non renseignée | À confirmer | Compte pro EI (SIREN 482 511 292) | ❓ | `COMPTES_BANCAIRES_SOCIETES_PRIVE.md` |
...
- **DFENSER (FR)** : EI SIREN 482 511 292, APE 6622Z, 20 rue du Rhin 59200 Tourcoing — banque NON renseignée dans les docs.
...
2. **DFENSER** : quelle banque tient le compte EI ? Toujours active ?
...
6. **Stripe** : entité juridique choisie pour le compte (EI DFENSER FR ou nouvelle entité IL via Mizrahi) ?
