...
(function(){
  ...
  var SAVOIR = [
    ...
    { mots: ['langues','quelle langue','languages','какие языки','שפות','لغات'],
      r: { fr: "NAVLYS te parle en français, anglais, russe, hébreu et arabe. Choisis ta langue dans le menu ⚙️.",
           en: "NAVLYS speaks French, English, Russian, Hebrew and Arabic. Pick your language in the ⚙️ menu.",
           ru: "NAVLYS говорит по-французски, по-английски, по-русски, на иврите и по-арабски. Выбери язык в меню ⚙️.",
           he: "NAVLYS מדבר צרפתית, אנגלית, רוסית, עברית וערבית. בחר את השפה בתפריט ⚙️.",
           ar: "NAVLYS يتحدث الفرنسية والإنجليزية والروسية والعبرية والعربية. اختر لغتك من قائمة ⚙️." } },
