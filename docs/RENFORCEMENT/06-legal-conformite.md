...
- **À trancher** : FR auto-entrepreneur (franchise TVA) vs **société IL** (banque Mizrahi) vs **DFENSER
...
- Toute mention **« Israël / Jérusalem / Ashkelon »** (garder le fuseau horaire en interne seulement),
  numéro **+972**, mentions résiduelles **« NOVA » / « DFENSER »**, et toute trace **CIF/ORIAS**.
...
- **Résidus public** à nettoyer (Israël/Jérusalem/+972/NOVA/DFENSER/CIF).
...
- [ ] **Entité juridique** définitive (FR auto-entrepreneur / société IL / DFENSER LTD).
...
- [ ] Feu vert pour le **nettoyage public** (Israël/+972/NOVA/DFENSER/CIF).
