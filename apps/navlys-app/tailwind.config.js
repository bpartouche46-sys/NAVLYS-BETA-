/** tailwind.config.js — reconstitué depuis live-source/app-config/tailwind.config.js (référence Drive 2026-06-25).
 *  Charte NAVLYS verrouillée : Ice Blue #7DD3FC + bronze/or/nuit/perle (CLAUDE.md).
